...
(function () {
    ...
    window.fetch = function () {
        return originalFetch.apply(this, arguments).then((res) => {
            ...
            if (!window.loaded) {
                console.clear();
                console.log("%cKhan Academy Answer Revealer ", "color: mediumvioletred; -webkit-text-stroke: .5px black; font-size:40px; font-weight:bolder; padding: .2rem;");
                console.log("%cCreated by Theodore Romero (@theodoreromero)", "color: white; -webkit-text-stroke: .5px black; font-size:15px; font-weight:bold;");
                window.loaded = true;
            }
